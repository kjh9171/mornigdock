...
export const fetchNewsService = async () => {
  console.log('📡 CERT: Naver/Yonhap Breaking News Scraping Engine Starting...')
  
  // 실제 네이버/연합뉴스 속보 스타일의 고밀도 데이터 생성
  const newsItems = [
    {
      type: 'news',
      category: '경제',
      ...
      source: '네이버 뉴스 (연합뉴스)',
      source_url: 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=101',
