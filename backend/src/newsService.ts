...
export const fetchNewsService = async () => {
  ...
  const flashNewsItems = [
    {
      type: 'news',
      category: '뉴스 분석', // 🔥 '경제'에서 '뉴스 분석'으로 카테고리 고정
      title: '[사령부 지능분석] 한은, 기준금리 3.50%로 10회 연속 동결…물가 불확실성 여전',
...
- 부동산 PF 관련 뉴스의 실시간 큐레이션 강화 지시.`
    ...
    {
      type: 'news',
      category: '뉴스 분석', // 🔥 '기술'에서 '뉴스 분석'으로 카테고리 고정
      title: '[사령부 지능분석] 정부, "AI 반도체에 9.4조 투자…글로벌 3대 강국 도약" 선언',
