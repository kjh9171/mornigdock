...
const FINANCE_SECTIONS = [
  { id: 'domestic', name: '국내증시', icon: TrendingUp, url: 'https://m.stock.naver.com/domestic/index/KOSPI/total', color: 'text-red-600', bg: 'bg-red-50' },
  { id: 'overseas', name: '해외증시', icon: Globe, url: 'https://m.stock.naver.com/world/index/.IXIC', color: 'text-blue-600', bg: 'bg-blue-50' },
  ...
  { id: 'indices', name: '시장지표', icon: BarChart3, url: 'https://m.stock.naver.com/marketindex/home', color: 'text-emerald-600', bg: 'bg-emerald-50' },
  { id: 'crypto', name: '가상자산', icon: Coins, url: 'https://m.stock.naver.com/crypto/home', color: 'text-purple-600', bg: 'bg-purple-50' },
...
export function FinanceCenter() {
  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {/* 3. 실전 데이터 모니터링 섹션 (아이프레임 또는 요약 데이터 영역 - 확장 가능) */}
      <div className="bg-white rounded-3xl border border-stone-200 p-8 shadow-inner">
        <div className="flex items-center gap-2 mb-6">
          <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse" />
          <h2 className="text-sm font-black text-stone-800 uppercase tracking-widest">Live Strategic Portal</h2>
        </div>
        
        <div className="bg-stone-50 rounded-2xl p-10 border-2 border-dashed border-stone-200 text-center">
          <p className="text-stone-400 font-bold text-sm mb-4">
